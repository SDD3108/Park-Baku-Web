...
const PopularPageBuilder = () => {
  ...
  const fetchPopularDishes = async()=>{
    try{
      ...
      const sortedData = response.data.sort((a:PopularDish, b:PopularDish)=> b.total_orders - a.total_orders)
...
export default PopularPageBuilder